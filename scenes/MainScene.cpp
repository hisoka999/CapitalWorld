...
MainScene::MainScene(core::Renderer *pRenderer,
                ...
                core::Scene(pRenderer, &uiTexture), running(true), sceneManager(
                                pSceneManager)
{
        ...
        SDL_Color white =
        { 255, 255, 255, 0 };
        UI::Button *btnStart = new UI::Button();
        ...
        UI::Button *btnLoadGame = new UI::Button();
        ...
        UI::Button *btnExit = new UI::Button();
...
void MainScene::render()
{
        ...
        container->render(renderer, &uiTexture);
}
